<template>
    <div class="auth-reg auth-reg--auth">
        <div class="auth-reg__header">
            ...
            <svg @click="togglePopupAuth" class="icon-close icon-close--auth-reg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
        ...
        <div class="auth-reg__input-section">
            <div class="auth-reg__input-block">
                ...
                <input class="input" type="text" name="e-mail" placeholder="Электронная почта">
            </div>
            <div class="auth-reg__input-block">
        ...
        <div class="auth-reg__button-section">
            <a class="button button--auth auth-reg__button" href="">Войти в систему</a>
        </div>
    </div>
</template>
