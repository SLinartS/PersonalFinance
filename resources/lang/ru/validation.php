...
return [
    ...
    'custom'               => [
        'name' => [
            ...
            'min' => 'Имя пользователя должно быть не короче :min символов'
        ],
        'email' => [
        ...
        'password' => [
            ...
            'min' => 'Пароль должнен быть не короче :min символов'
        ],
        'repPassword' => [
        ...
        'title' => [
            ...
            'min' => 'Название не может быть короче :min символов',
            'max' => 'Название не может быть длиннее :max символов',
        ],
        'description' => [
            'required' => 'Укажите описание',
            'min' => 'Описание не может быть меньше :min символов',
            'max' => 'Описание не может быть больше :max символов',
        ],
        'amount' => [
            'required' => 'Введите сумму',
            'numeric' => 'Сумма не может содержать буквенные символы',
            'max' => 'Сумма не может содержать больше 15 символов',
        ],
        'time' => [
            'required' => 'Укажите дату и время',
            'date_format' => 'Неверный формат даты и времени',
        ],
        'selected' => [
            'required' => 'Укажите опцию',
        ],
        'img' => [
